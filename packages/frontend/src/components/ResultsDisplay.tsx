...
const ResultsDisplay = ({ results }: ResultsDisplayProps) => {
    ...
    return (
        <Card className="p-6 bg-card border border-border shadow-lg animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div className="p-3 bg-secondary/50 rounded-lg border border-border">
                            ...
                            <span className="text-sm font-medium capitalize text-accent">
                                {results.status}
                            </span>
                        </div>
